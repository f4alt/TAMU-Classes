...
// // TESTING
// int main() {
//   SegmentHeader* seg1 = new SegmentHeader(100,true);
//   SegmentHeader* seg2 = new SegmentHeader(100,true);
//   SegmentHeader* seg3 = new SegmentHeader(100,true);
//   FreeList list;
//
//   cout << "seg1:" << seg1 << "/ seg2:" << seg2 << "/ seg3:" << seg3 << endl;
//
//   list.Add(seg3);
//   list.Add(seg2);
//   list.Add(seg1);
//
//   // cout<<list.Size()<<" "<<list.Head()<<endl;
//   list.PrintList();
//
//   // list.Remove(seg1);
//   // // cout<<list.Size()<<" "<<list.Head()<<endl;
